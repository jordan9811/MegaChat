...
| 41 | **Mainnet deployment and seats wired to the escrow** — deposit at join, ledger figure into `attest`, buried seconds into `hiddenSeconds`, a mainnet dust seat end to end | none yet — Session 2 of `megachat-escrow-contract.md` | — | ☐ |
